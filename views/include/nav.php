...
<nav class="navbar navbar-expand-lg bg-dark navbar-light">
  <div class="container-fluid">
    <a class="navbar-brand text-light" href="index.php?action=list">Navbar</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link text-light" aria-current="page" href="index.php?action=list">Liste des stagiaires</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="index.php?action=create">Ajouter stagiaire</a>
        </li>
      </ul>
    </div>
  </div>
